...
export default class Opening extends Phaser.State {
  ...
  EagleUpdate() {
    ...
    if(this.eagleState == 'dive1') {
      ...
      var speed = [0, 0, -2, -5, -12, 2, -3, -8, -5];
      this.eagle.y += speed[this.eagle.animations.frame] * 2.5;

      // calculate crystal offset
      var offsetX = [-260, -260, -315, -250, -245, -220, -220, -230, -232];
      var offsetY = [-105, -45,   -35, -75, -165, -100, -115, -120, -95];
      var rotation = [0.65, 0.72, 1.8, 0.65, 0.85, 0.58, 0.61, 0.95, 0.65];
      for (var i = 0; i < 5; i++) {
